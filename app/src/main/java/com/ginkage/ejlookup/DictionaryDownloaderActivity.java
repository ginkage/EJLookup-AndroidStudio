...
public class DictionaryDownloaderActivity extends Activity implements IDownloaderClient {
    ...
    public static final XAPKFile[] xAPKS = {
            new XAPKFile(
                    ...
                    13, // the version of the APK that the file was uploaded
                       // against
                    103569460L // the length of the file in bytes
            )            
    };
...
*/                mPauseButton.setText(R.string.text_button_cancel_verify);
    ...
    private void initializeDownloadUI() {
        mDownloaderClientStub = DownloaderClientMarshaller.CreateStub
                (this, DictionaryDownloaderService.class);
        ...
        if (!expansionFilesDelivered()) {
            try {
                ...
                int startResult = DownloaderClientMarshaller.startDownloadServiceIfRequired(this,
                        pendingIntent, DictionaryDownloaderService.class);
