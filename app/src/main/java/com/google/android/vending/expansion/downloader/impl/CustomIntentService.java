...
/**
 * This service differs from IntentService in a few minor ways/ It will not auto-stop itself after
 * the intent is handled unless the target returns "true" in should stop. Since the goal of this
 * service is to handle a single kind of intent, it does not queue up batches of intents of the same
 * type.
 */
