 ...
 *
 * <p>Most importantly, you must call {@link #CreateProxy} during the {@link
 * IDownloaderClient#onServiceConnected} callback in your activity in order to instantiate an {@link
 * IDownloaderService} object that you can then use to issue commands to the {@link
...
public class DownloaderServiceMarshaller {
    ...
    /**
     * Returns a stub object that, when connected, will listen for marshalled IDownloaderService
     * methods and translate them into calls to the supplied interface.
     *
     * @param itf An implementation of IDownloaderService that will be called when remote method
     *     calls are unmarshalled.
     * @return
     */
