...
/**
 * This class handles displaying the notification associated with the download queue going on in the
 * download manager. It handles multiple status types; Some require user interaction and some do
 * not. Some of the user interactions may be transient. (for example: the user is queried to
 * continue the download on 3G when it started on WiFi, but then the phone locks onto WiFi again so
 * the prompt automatically goes away)
 *
 * <p>The application interface for the downloader also needs to understand and handle these
 * transient states.
 */
public class DownloadNotification implements IDownloaderClient {
    ...
    /**
     * Called in response to onClientUpdated. Creates a new proxy and notifies it of the current
     * state.
     *
