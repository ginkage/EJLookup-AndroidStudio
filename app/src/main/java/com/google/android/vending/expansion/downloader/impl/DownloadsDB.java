...
public class DownloadsDB {
    ...
    protected static class DownloadsContentDBHelper extends SQLiteOpenHelper {
        ...
        private String createTableQueryFromArray(
        ...
        /**
         * These two arrays must match and have the same order. For every Schema there must be a
        ...
        /**
         * Goes through all of the tables in sTables and drops each table if it exists. Altered to
         * no longer make use of reflection.
         */
        ...
        /**
         * Goes through all of the tables in sTables and creates a database with the corresponding
         * schema described in sSchemas. Altered to no longer make use of reflection.
         */
        ...
        public void onUpgrade(SQLiteDatabase paramSQLiteDatabase, int paramInt1, int paramInt2) {
            Log.w(
                    DownloadsContentDBHelper.class.getName(),
        ...
        if (-1 == this.mMetadataRowID) {
            ...
            if (0
                    == sqldb.update(
                            MetadataColumns.TABLE_NAME,
                            cv,
                            BaseColumns._ID + " = " + mMetadataRowID,
                            null)) return false;
        }
        return true;
    }
    ...
    public DownloadInfo getDownloadInfoFromCursor(Cursor cur) {
        DownloadInfo di =
                new DownloadInfo(
                        cur.getInt(INDEX_IDX),
                        cur.getString(FILENAME_IDX),
