 ...
 * HttpRequestInterceptor} classes. Don't create this directly, use the {@link #newInstance} factory
 * method.
 *
...
public final class AndroidHttpClient implements HttpClient {
    ...
    public static AndroidHttpClient newInstance(String userAgent, Context context) {
        ...
        if (null != sessionCache) {
            ...
            try {
                getHttpSocketFactoryMethod =
                        SSLCertificateSocketFactory.class.getDeclaredMethod(
                                "getHttpSocketFactory", Integer.TYPE, sSslSessionCacheClass);
                sslCertificateSocketFactory =
                        (SocketFactory)
                                getHttpSocketFactoryMethod.invoke(
                                        null, SOCKET_OPERATION_TIMEOUT, sessionCache);
            } catch (SecurityException e) {
                // TODO Auto-generated catch block
                e.printStackTrace();
            } catch (NoSuchMethodException e) {
                ...
                new DefaultHttpClient(ccm, params) {
                    ...
                    protected HttpContext createHttpContext() {
                        ...
                        context.setAttribute(
                                ClientContext.CREDS_PROVIDER, getCredentialsProvider());
                        return context;
                    }
                };
    }
    ...
    /**
     * Modifies a request to indicate to the server that we would like a gzipped response. (Uses the
    ...
    /**
     * Release resources associated with this client. You must call this, or significant resources
     * (sockets and memory) may be leaked.
     */
    public void close() {
        if (mLeakedException != null) {
     ...
     * will not be compressed if it is too short.
     *
    ...
    public void enableCurlLogging(String name, int level) {
        ...
        if (level < Log.VERBOSE || level > Log.ASSERT) {
            throw new IllegalArgumentException(
                    "Level is out of range [" + Log.VERBOSE + ".." + Log.ASSERT + "]");
        }
    ...
    /**
     * Returns the date of the given HTTP date string. This method can identify and parse the date
     * formats emitted by common HTTP servers, such as <a
     ...
     * href="http://www.opengroup.org/onlinepubs/007908799/xsh/asctime.html">ANSI C's asctime()</a>.
     *
