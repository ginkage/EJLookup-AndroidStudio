...
public class V3CustomNotification implements DownloadNotification.ICustomNotification {
    ...
    public Notification updateNotification(Context c) {
        ...
        expandedView.setTextViewText(
                R.id.description, Helpers.getDownloadProgressString(mCurrentBytes, mTotalBytes));
        ...
        expandedView.setTextViewText(
                R.id.time_remaining,
                c.getString(
                        R.string.time_remaining_notification,
                        Helpers.getTimeRemaining(mTimeRemaining)));
        expandedView.setTextViewText(
                R.id.progress_text, Helpers.getDownloadProgressPercent(mCurrentBytes, mTotalBytes));
